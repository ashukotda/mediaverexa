  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      content: 'contact@verexamedia.com',
      link: 'mailto:contact@verexamedia.com'
    },
    {
      icon: Phone,
      title: 'Phone',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <div>
                ...
                <p className="font-paragraph text-lg text-foreground/70 mb-8">
                  We're located in the heart of New York City. Feel free to stop by for a coffee and a chat about your project.
                </p>
              </div>
