...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-paragraph overflow-clip selection:bg-primary selection:text-primary-foreground">
        ...
        <div className="max-w-[120rem] mx-auto px-6 md:px-12">
          <div className="text-center mb-20">
            ...
            <p className="font-paragraph text-lg text-foreground/60 max-w-2xl mx-auto">
              Real results from real partnerships. See what our clients have to say about working with Verexa Media.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1, duration: 0.5 }}
                className={`bg-background p-10 rounded-2xl shadow-sm border border-border/50 flex flex-col justify-between ${index === 1 ? 'md:-mt-8 md:mb-8 border-primary/20 shadow-lg' : ''}`}
              >
                <div className="mb-8">
                  <div className="flex gap-1 mb-6">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <Zap key={star} className="h-4 w-4 text-primary fill-primary" />
                    ))}
                  </div>
                  <p className="font-paragraph text-lg text-foreground/80 italic leading-relaxed">
                    "{testimonial.quote}"
                  </p>
                </div>
      ...
      <section className="w-full py-32 bg-background border-t border-border/50">
        <div className="max-w-[120rem] mx-auto px-6 md:px-12">
          <div className="flex flex-col md:flex-row justify-between items-center mb-16">
            ...
            <Link to="/blog" className="hidden md:block">
              <Button variant="outline" className="rounded-full px-8 border-foreground/20 hover:bg-foreground hover:text-background transition-colors">
                Visit Our Blog
              </Button>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Featured Article (Simulated with static data for layout) */}
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              <div className="overflow-hidden rounded-2xl mb-6 aspect-[16/9]">
                <Image 
                  src="https://static.wixstatic.com/media/0eba7f_094d4c53df1f478280adb3d91a0139ed~mv2.png?originWidth=960&originHeight=512" 
                  alt="Digital Strategy" 
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                />
              </div>
              <div className="flex items-center gap-4 mb-4 text-sm text-foreground/50">
              ...
              <p className="font-paragraph text-foreground/60 mb-6">
                Discover how AI and data analytics are reshaping the way brands connect with their audiences.
              </p>
            ...
            >
              <div className="overflow-hidden rounded-2xl mb-6 aspect-[16/9]">
                <Image 
                  src="https://static.wixstatic.com/media/0eba7f_136959f009bb4e7b8dba07f6d8610952~mv2.png?originWidth=960&originHeight=512" 
              ...
              <h3 className="font-heading text-2xl md:text-3xl font-bold text-foreground mb-3 group-hover:text-primary transition-colors">
                Mastering Technical SEO for Growth
              </h3>
              <p className="font-paragraph text-foreground/60 mb-6">
                A comprehensive guide to optimizing your site architecture for better search engine visibility.
              </p>
              <span className="inline-flex items-center text-primary font-medium group-hover:translate-x-2 transition-transform">
                Read Article <ArrowRight className="ml-2 h-4 w-4" />
              </span>
          ...
          <div className="mt-12 md:hidden text-center">
             <Link to="/blog">
              <Button variant="outline" className="w-full rounded-full px-8 border-foreground/20">
                Visit Our Blog
              </Button>
            </Link>
          </div>
